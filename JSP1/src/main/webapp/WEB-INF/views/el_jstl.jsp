...
<body>
	...
	<%--
	 ...
	 --%>
		...
		- 기본 작성법 : \${key} (실제 사용시 백슬래시 제거하고 사용)
	</pre>
	
	<h3>전달받은 파라미터 출력하는 방법</h3>
	
	<p style="color : red;">
		주소 뒤에 쿼리스트링(?name=홍길동&age=23)
		직접 작성하면서 테스트
	</p>
	...
	2. 프로젝트 webapp/WEB-INF/lib 폴더에 다운로드 받은 라이브러리 추가(드래그앤드랍 , 복붙)
